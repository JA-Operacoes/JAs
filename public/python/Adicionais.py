...
# Gera proposta de adicionais DOCX
def gerar_proposta(dados):
    ...
    nome_arquivo = f"Proposta-Adicional_{to_unicode(dados.get('nomenclatura'))}_{to_unicode(dados.get('evento_nome', 'Sem Evento'))}_.docx"
    caminho_saida = os.path.join(pasta_saida, nome_arquivo)

    doc.save(caminho_saida)
    print(f"✅ Proposta-Adicional salvo: {caminho_saida}", file=sys.stderr)
