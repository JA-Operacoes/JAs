...
async function verificaFuncionarios() {
    ...
    botaoEnviar.addEventListener("click", async (event) => {
        ...
        if (!nome || !cpf || !rg || !celularPessoal || !email || !cep || !rua || !numero || !bairro || !cidade || !estado || !pais || !perfil || !dataNascimento || !nomeFamiliar) {
            return Swal.fire("Campos obrigatórios!", "Preencha todos os campos obrigatórios: Nome, Data Nascimento, CPF, RG, Celular Pessoal, E-mail, CEP, Rua, Número, Bairro, Cidade, Estado, País e Perfil.", "warning");
        }
