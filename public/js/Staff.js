...
            text: `O limite de ${limite} para esta função (Setor: ${criterios.setor || 'Geral'}) já foi alcançado. Existem ${dadosOrcamento.quantidadeEscalada} funcionários já salvos para este período e ${countNaTabela} adicionados na lista atual.`,
        });
        return false;
    }
