    ...
    try {
      ...
      let query = `
        SELECT
            ...
            o.totgeralvda, o.totgeralcto, o.totajdcto, o.totaditivo, o.totbonificado, o.lucrobruto,
    ...
    try {
      ...
      const insertOrcamentoQuery = `
                INSERT INTO orcamentos (
                    ...
                    totgeralvda, totgeralcto, totajdcto, totaditivo, totbonificado, lucrobruto, percentlucro,
...
router.put("/:id",
  ...
  async (req, res) => {
    ...
    const { 
      ...
      dtIniRealizacao, dtFimRealizacao, dtIniDesmontagem, dtFimDesmontagem,
      dtIniDesmontagemInfra, dtFimDesmontagemInfra, obsItens, obsProposta,
      totGeralVda, totGeralCto, totAjdCusto, totAditivo, totBonificado, lucroBruto, percentLucro,
      desconto, percentDesconto, acrescimo, percentAcrescimo,
      lucroReal, percentLucroReal, vlrImposto, percentImposto, vlrCliente, idsPavilhoes, nomenclatura,
      formaPagamento, edicao, geradoAnoPosterior, dtIniPreEvento, dtFimPreEvento, dtIniPosEvento,
      dtFimPosEvento, avisoReajusteTexto, vlrCtoFixo, percentCtoFixo, itens, contratarstaff,
    ...
    try {
      ...
      const updateOrcamentoQuery = `UPDATE orcamentos SET
                        ...
                        dtinirealizacao = $12, dtfimrealizacao = $13, dtinidesmontagem = $14, dtfimdesmontagem = $15,
                        dtiniinfradesmontagem = $16, dtfiminfradesmontagem = $17, obsitens = $18, obsproposta = $19,
                        totgeralvda = $20, totgeralcto = $21, totajdcto = $22, totaditivo = $23, totbonificado = $24,
                        lucrobruto = $25, percentlucro = $26,
                        desconto = $27, percentdesconto = $28, acrescimo = $29, percentacrescimo = $30,
                        lucroreal = $31, percentlucroreal = $32, vlrimposto = $33, percentimposto = $34, vlrcliente = $35,
                        nomenclatura = $36, formapagamento = $37, edicao = $38, geradoanoposterior = $39, dtinipreevento = $40,
                        dtfimpreevento = $41, dtiniposevento = $42, dtfimposevento = $43, indicesaplicados = $44, vlrctofixo = $45,
                        percentctofixo = $46, contratarstaff = $47, idempresaemissora = $48
                 WHERE idorcamento = $49  AND (SELECT idempresa FROM orcamentoempresas WHERE idorcamento = $49) =$50 ;`;
      ...
      const orcamentoValues = [
        ...
        dtIniRealizacao, dtFimRealizacao, dtIniDesmontagem, dtFimDesmontagem,
        dtIniDesmontagemInfra, dtFimDesmontagemInfra, obsItens, obsProposta,
        totGeralVda, totGeralCto, totAjdCusto, totAditivo || 0, totBonificado || 0, lucroBruto, percentLucro,
        desconto, percentDesconto, acrescimo, percentAcrescimo,
        lucroReal, percentLucroReal, vlrImposto, percentImposto, vlrCliente, nomenclatura,
        formaPagamento, edicao, geradoAnoPosterior, dtIniPreEvento, dtFimPreEvento, dtIniPosEvento, dtFimPosEvento,
