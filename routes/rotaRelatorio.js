            ...
            fechamentoCache.forEach(item => {
                ...
                if (!totaisPorEvento[eventoId]) {
                    totaisPorEvento[eventoId] = {
                        ...
                        totalTotalCaixinha: 0,  // ✅ ADICIONADO
                        totalTotalDiarias: 0,
                        totalTotalAjuda: 0,
                        totalTotalGeral: 0,
                        totalTotalPagar: 0
                ...
                totaisPorEvento[eventoId].totalTotalCaixinha += parseFloat(item["VLR CAIXINHA"] || 0);
