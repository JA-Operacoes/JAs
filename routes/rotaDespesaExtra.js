...
router.get("/eventos",
    verificarPermissao("DespesaExtras", "pesquisar"),
    async (req, res) => {
...
router.post("/",
    verificarPermissao("DespesaExtras", "cadastrar"),
    uploadComprovanteDespesa,
    logMiddleware("DespesaExtras", {
...
router.put("/:idDespesaExtra",
    verificarPermissao("DespesaExtras", "alterar"),
    uploadComprovanteDespesa,
    logMiddleware("DespesaExtras", {
